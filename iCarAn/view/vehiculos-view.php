        ...
        <section id="main-content">
            ...
            <div class="row">
                ...
                <div class="col-md-offset-10">
                    ...
                    <button onclick="generarPDF(1)" class="btn btn-primary">PDF</button>
...
<script>
    ...
    if (confirm('Esta acción generará un archivo PDF del vehículo. ¿Desea continuar?')) {
        ...
        $.ajax({
            ...
            success: function (data) {
                // 'data' ahora contiene un objeto JSON con la información del vehículo

                // Crear un nuevo objeto jsPDF
                var pdf = new jsPDF();

                // Agregar contenido al PDF
                pdf.text(10, 10, 'Marca: ' + data.marca);
                pdf.text(10, 20, 'Modelo: ' + data.modelo);
                pdf.text(10, 30, 'Color: ' + data.color);
                // Agrega más líneas según la estructura de tu tabla en la base de datos

                // Guardar el PDF como un archivo
                pdf.save('vehiculo.pdf');

                // Limpiar el loader después de generar el PDF
                $("#loader").html("");
            }
        });
    }
