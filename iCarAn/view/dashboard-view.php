                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body text-center">
                                <p class="text-center">
                                    <strong><span class="text-muted">Mecánico</span> & <span class="text-info">Taller</span> <b><?php echo date('Y');?></b></strong>
                                </p>
                                <div class="col-md-6 col-sm-6">
                                <img src="assets/img/tallermecanico.png" alt="">
                                </div>
                                <div class="col-md-6 col-sm-6">
                                <canvas id="bar" height="450px" width="800px" display="block"></canvas>
                                </div>
